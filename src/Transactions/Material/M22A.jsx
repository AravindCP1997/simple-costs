...
export function ConsignmentOutwardsOriginCustomer() {
  const defaults = {
    CompanyCode: "",
    ValueDate: "",
    AccYear: "",
    ...
    ],
    {
      Movements: Items.map((item, i) =>
        transformObject(
          ...
          { MovementType: "22", LocationCode: Location, Customer, No: i + 1 },
        ),
      ),
    },
  );
  ...
  return (
    <>
      <WindowTitle
        title={"Consignment Outwards Origin against Customer"}
        menu={[
          <ConditionalButton
            name={"Post"}
            result={!errorsExist}
