...
import { BusinessPlace, Plant, ProfitCenter } from "../classes";
...
import { defaultPlant } from "../defaults";

export function ManagePlant() {
  const [code, setcode] = useState("");
  const [company, setcompany] = useState("");
  const collection = new Plant(code, company);
    ...
    <>
      <WindowTitle
        ...
        menu={[
          <Button
            name={"New"}
            functionsArray={[() => openWindow(<CreatePlant />)]}
          />,
          <ConditionalButton
            name={"View"}
            result={collection.exists()}
            whileFalse={[() => showAlert("Plant does not exist.")]}
            whileTrue={[
              () =>
                openWindow(
                  <CreatePlant method="View" initial={collection.getData()} />
                ),
            ]}
          />,
          <ConditionalButton
            ...
            whileFalse={[
              () =>
                showAlert(
                  "Either the Plant does not exist, or it is not in draft stage to be updated."
                ),
            ]}
            whileTrue={[
              () =>
                openWindow(
                  <CreatePlant method="Update" initial={collection.getData()} />
                ),
            ]}
          />,
          <ConditionalButton
            ...
            whileFalse={[
              () =>
                showAlert(
                  "Either the Plant does not exist, or it is not in draft stage to be deleted."
                ),
            ]}
            whileTrue={[
              () =>
          ...
          <ConditionalButton
            ...
            whileTrue={[
              () =>
                openWindow(
                  <CreatePlant method="Create" initial={collection.getData()} />
                ),
            ]}
          />,
        ]}
...
export function CreatePlant({ initial = defaultPlant, method = "Create" }) {
  ...
  useEffect(() => {
    ...
    if (method === "Create") {
      ...
      addError(
        ...
        "Code",
        `Plant ${Code} already exists in Company ${Company}.`
      );
    }
      ...
      <>
        <WindowTitle
          ...
          menu={[
            ...
            <Button
              name="Manage"
              functionsArray={[() => openWindow(<ManagePlant />)]}
            />,
          ]}
        />
        <WindowContent>
