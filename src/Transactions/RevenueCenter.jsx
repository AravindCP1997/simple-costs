...
import { BusinessPlace, RevenueCenter, ProfitCenter } from "../classes";
...
import { defaultRevenueCenter } from "../defaults";

export function ManageRevenueCenter() {
  const [code, setcode] = useState("");
  const [company, setcompany] = useState("");
  const collection = new RevenueCenter(code, company);
  const { openWindow, openConfirm, showAlert } = useInterface();

  return (
    <>
      <WindowTitle
        title={"Manage Revenue Center"}
        menu={[
          <Button
            name={"New"}
            functionsArray={[() => openWindow(<CreateRevenueCenter />)]}
          />,
          <ConditionalButton
            name={"View"}
            result={collection.exists()}
            whileFalse={[() => showAlert("Revenue Center does not exist.")]}
            whileTrue={[
              () =>
                openWindow(
                  <CreateRevenueCenter
          ...
          <ConditionalButton
            ...
            whileFalse={[
              () =>
                showAlert(
                  "Either the Revenue Center does not exist, or it is not in draft stage to be updated."
                ),
            ]}
            whileTrue={[
              () =>
          ...
          <ConditionalButton
            ...
            whileFalse={[
              () =>
                showAlert(
                  "Either the Revenue Center does not exist, or it is not in draft stage to be deleted."
                ),
            ]}
            whileTrue={[
              () =>
                openConfirm(
                  "This action will permanently delete the Revenue Center.",
                  [],
                  [
...
export function CreateRevenueCenter({
  initial = defaultRevenueCenter,
  method = "Create",
}) {
  ...
  useEffect(() => {
    ...
    if (method === "Create") {
      ...
      addError(
        ...
        "Code",
        `Revenue Center ${Code} already exists in Company ${Company}.`
      );
    }
      ...
      <>
        <WindowTitle
          ...
          menu={[
            ...
            <Button
              name="Manage"
              functionsArray={[() => openWindow(<ManageRevenueCenter />)]}
            />,
          ]}
        />
        <WindowContent>
          ...
          menu={[
            <ConditionalButton
              ...
              whileTrue={[
                ...
                () => openWindow(<ManageRevenueCenter />),
              ]}
            />,
            <Button name={"Reset"} functionsArray={[() => reset()]} />,
            <DisplayHidingError />,
