...
import { defaultVendor } from "../defaults";
...
export function ManageVendor() {
  ...
  const collection = new Vendor(code, company);
    ...
    <>
      <WindowTitle
        ...
        menu={[
          <Button
            name="New"
            functionsArray={[() => openWindow(<CreateVendor />)]}
          />,
          <ConditionalButton
            name={"View"}
            ...
            whileTrue={[
              () =>
                openWindow(
                  <CreateVendor method="View" initial={collection.getData()} />,
                ),
            ]}
          />,
          <ConditionalButton
...
export function CreateVendor({ initial = defaultVendor, method = "Create" }) {
  const {
    data,
    changeData,
    reset,
  ...
  const collection = new Vendor(Code, Company);
  const group = new VendorGroup(VendorGroupCode, Company);
  ...
  useEffect(() => {
    ...
    if (method === "Create") {
      ...
      addError(!group.exists(), "VendorGroup", "Vendor Group does not exist.");
        ...
        <MultiDisplayArea
          ...
          contents={[
            <Column overflow="visible" borderBottom="none">
              ...
              <Row overflow="visible">
                <Label label={"Vendor Group"} />
                <Conditional logic={method === "Create"}>
                  <AutoSuggestInput
                    value={VendorGroupCode}
                    process={(value) =>
                      changeData("", "VendorGroupCode", value)
                    }
