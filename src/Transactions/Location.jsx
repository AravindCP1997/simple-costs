...
import { BusinessPlace, Location, ProfitCenter } from "../classes";
...
export function ManageLocation() {
  ...
  const collection = new Location(code, company);
    ...
    <>
      <WindowTitle
        ...
        menu={[
          <Button
            name={"New"}
            functionsArray={[() => openWindow(<CreateLocation />)]}
          />,
          <ConditionalButton
            name={"View"}
            result={collection.exists()}
            whileFalse={[() => showAlert("Location does not exist.")]}
            whileTrue={[
              () =>
                openWindow(
                  <CreateLocation
          ...
          <ConditionalButton
            ...
            whileFalse={[
              () =>
                showAlert(
                  "Either the Location does not exist, or it is not in draft stage to be updated."
                ),
            ]}
            whileTrue={[
              () =>
          ...
          <ConditionalButton
            ...
            whileFalse={[
              () =>
                showAlert(
                  "Either the Location does not exist, or it is not in draft stage to be deleted."
                ),
            ]}
            whileTrue={[
              () =>
  ...
  useEffect(() => {
    ...
    if (method === "Create") {
      ...
      addError(
        ...
        "Code",
        `Location ${Code} already exists in Company ${Company}.`
      );
    }
      ...
      <>
        <WindowTitle
          ...
          menu={[
            ...
            <Button
              name="Manage"
              functionsArray={[() => openWindow(<ManageLocation />)]}
            />,
          ]}
        />
        <WindowContent>
