...
class Navigator {
  static codes = [
    ...
    {
      code: "gb10d",
      name: "Display Chart of Accounts",
      url: "/interface",
      state: {
    ...
    },
    {
      ...
      state: {
        type: "Collection",
        collection: "GroupChartOfAccounts",
        method: "Create",
      },
      type: "Control",
      group: "Global",
    ...
    {
      code: "gb30d",
      name: "Display Group Chart of Accounts",
      url: "/interface",
      state: {
        type: "CollectionQuery",
        collection: "GroupChartOfAccounts",
    ...
    {
      code: "gb40d",
      name: "Display Group General Ledger",
      url: "/interface",
      state: {
        type: "CollectionQuery",
        collection: "GroupGeneralLedger",
    ...
    },
    {
      ...
      url: "/interface",
      state: { type: "Collection", collection: "WageType", method: "Create" },
      type: "Control",
      group: "Global",
    },
    {
      code: "gb60u",
      name: "Update Wage Type",
      url: "/interface",
      state: {
        type: "CollectionQuery",
        collection: "WageType",
    ...
    },
    {
      ...
      name: "Currencies",
      url: "/interface",
      state: { type: "Table", table: "Currencies", method: "Display" },
      type: "Control",
      group: "Global",
    },
    {
      ...
      name: "HSN",
      url: "/interface",
      state: { type: "Table", table: "HSN", method: "Display" },
      type: "Control",
      group: "Global",
    },
    {
      ...
      name: "Segments",
      url: "/interface",
      state: { type: "Table", table: "Segments", method: "Display" },
      type: "Control",
      group: "Global",
    },
    {
      ...
      name: "Units",
      url: "/interface",
      state: { type: "Table", table: "Units", method: "Display" },
      type: "Control",
      group: "Global",
    },
    {
      ...
      name: "Wage Types",
      url: "/interface",
      state: { type: "Table", table: "WageTypes", method: "Display" },
      type: "Control",
      group: "Global",
    },
    {
      ...
      name: "Create Company",
      url: "/interface",
      state: { type: "Collection", collection: "Company", method: "Create" },
      type: "Control",
      group: "Company",
    },
    {
    ...
    },
    {
      ...
      name: "Create Plant",
      url: "/interface",
      state: { type: "CollectionQuery", collection: "Plant", method: "Create" },
      type: "Control",
      group: "Controlling",
    },
    {
      ...
      name: "Update Plant",
      url: "/interface",
      state: { type: "CollectionQuery", collection: "Plant", method: "Update" },
      type: "Control",
      group: "Controlling",
    },
    {
    ...
    {
      code: "op10d",
      name: "Display Maintenance Order",
      url: "/interface",
      state: {
        type: "CollectionQuery",
        collection: "MaintenanceOrder",
    ...
    },
    {
      ...
      name: "Create Asset",
      url: "/interface",
      state: { type: "Collection", collection: "Asset", method: "Create" },
      type: "Control",
      group: "Asset",
    },
    {
      ...
      name: "Update Asset",
      url: "/interface",
      state: { type: "CollectionQuery", collection: "Asset", method: "Update" },
      type: "Control",
      group: "Asset",
    },
    {
    ...
    },
    {
      ...
      url: "/interface",
      state: { type: "Collection", collection: "AssetGroup", method: "Create" },
      type: "Control",
      group: "Asset",
    },
    {
    ...
    {
      code: "asc30",
      name: "Create Asset Construction Order",
      url: "/interface",
      state: {
        type: "CollectionQuery",
        collection: "AssetConstructionOrder",
        method: "Create",
      },
      type: "Control",
      group: "Asset",
    ...
    {
      code: "asu30",
      name: "Update Asset Construction Order",
      url: "/interface",
      state: {
        type: "CollectionQuery",
        collection: "AssetConstructionOrder",
    ...
    {
      code: "asd30",
      name: "Display Asset Construction Order",
      url: "/interface",
      state: {
        type: "CollectionQuery",
        collection: "AssetConstructionOrder",
    ...
    },
    {
      ...
      type: "Control",
      group: "Costs and Accounting",
    },
    {
      code: "acc10d",
      name: "Display General Ledger",
      url: "/interface",
      state: {
        type: "CollectionQuery",
        collection: "GeneralLedger",
    ...
    },
    {
      ...
      name: "ACO Settlement",
      url: "/interface",
      state: { type: "Transaction", transaction: "ACOSettlement", data: {} },
      type: "Record",
      group: "Asset",
    },
    {
      ...
      name: "Depreciation",
      url: "/interface",
      state: { type: "Transaction", transaction: "Depreciation", data: {} },
      type: "Record",
      group: "Asset",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "AssetRevaluation", data: {} },
      type: "Record",
      group: "Asset",
    },
    {
      ...
      name: "Asset Scrap",
      url: "/interface",
      state: { type: "Transaction", transaction: "AssetScrap", data: {} },
      type: "Record",
      group: "Asset",
    },
    {
      ...
      name: "Asset Disposal",
      url: "/interface",
      state: { type: "Transaction", transaction: "AssetDisposal", data: {} },
      type: "Record",
      group: "Asset",
    },
    {
      ...
      state: {
        type: "Transaction",
        transaction: "GeneralAccounting",
        data: {},
      },
      type: "Record",
      group: "Cost and Accounting",
    },
    {
      code: "clrgen",
      name: "General Ledger Clearing",
      url: "/interface",
      state: {
        type: "Transaction",
        transaction: "GeneralLegderClearing",
        data: {},
      },
      type: "Record",
      group: "Cost and Accounting",
    },
    {
      ...
      state: {
        type: "Transaction",
        transaction: "PrepaidAmortisation",
        data: {},
      },
      type: "Record",
      group: "Cost and Accounting",
    },
    {
      ...
      state: {
        type: "Transaction",
        transaction: "PrepaidConsumption",
        data: {},
      },
      type: "Record",
      group: "Cost and Accounting",
    },
    {
      ...
      name: "Costing Run",
      url: "/interface",
      state: { type: "Transaction", transaction: "CostingRun", data: {} },
      type: "Record",
      group: "Cost and Accounting",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "RemunerationRun", data: {} },
      type: "Record",
      group: "Human Resources",
    },
    {
      code: "postrem",
      name: "Remuneration Posting",
      url: "/interface",
      state: {
        type: "Transaction",
        transaction: "RemunerationPosting",
        data: {},
      },
      type: "Record",
      group: "Human Resources",
    },
    {
      ...
      state: {
        type: "Transaction",
        transaction: "RemunerationPayment",
        data: {},
      },
      type: "Record",
      group: "Human Resources",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "MaterialReceipt", data: {} },
      type: "Record",
      group: "Material",
    },
    {
      ...
      state: {
        type: "Transaction",
        transaction: "MaterialAcceptance",
        data: {},
      },
      type: "Record",
      group: "Material",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "MaterialReturn", data: {} },
      type: "Record",
      group: "Material",
    },
    {
      ...
      name: "Material Issue",
      url: "/interface",
      state: { type: "Transaction", transaction: "MaterialIssue", data: {} },
      type: "Record",
      group: "Material",
    },
    {
      ...
      name: "Material Scrap",
      url: "/interface",
      state: { type: "Transaction", transaction: "MaterialScrap", data: {} },
      type: "Record",
      group: "Material",
    },
    {
      code: "lossitmat",
      name: "Material Loss in Transit",
      url: "/interface",
      state: {
        type: "Transaction",
        transaction: "MaterialLossInTransit",
        data: {},
      },
      type: "Record",
      group: "Material",
    },
    {
      ...
      name: "Vendor Invoice",
      url: "/interface",
      state: { type: "Transaction", transaction: "VendorInvoice", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "VendorCreditNote", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      ...
      name: "Vendor Payment",
      url: "/interface",
      state: { type: "Transaction", transaction: "VendorPayment", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "VendorClearing", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "CustomerInvoice", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      ...
      state: {
        type: "Transaction",
        transaction: "CustomerCreditNote",
        data: {},
      },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "CustomerPayment", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      ...
      url: "/interface",
      state: { type: "Transaction", transaction: "CustomerClearing", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
    ...
    },
    {
      ...
      name: "Batch Payments",
      url: "/interface",
      state: { type: "Transaction", transaction: "VANReceipts", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
    ...
    },
    {
      ...
      name: "Interest Run",
      url: "/interface",
      state: { type: "Transaction", transaction: "InterestRun", data: {} },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      code: "runforex",
      name: "Foreign Exchange Run",
      url: "/interface",
      state: {
        type: "Transaction",
        transaction: "ForeignExchangeRun",
        data: {},
      },
      type: "Record",
      group: "Payables and Receivables",
    },
    {
      ...
      name: "Asset Register",
      url: "/interface",
      state: { type: "ReportQuery", report: "AssetRegister" },
      type: "Reports",
      group: "Asset",
    },
    {
      ...
      name: "Asset Ledger",
      url: "/interface",
      state: { type: "ReportQuery", report: "AssetLedger" },
      type: "Reports",
      group: "Asset",
    },
    {
      code: "balas",
      name: "Asset Ledger Balance",
      url: "/interface",
      state: { type: "ReportQuery", report: "AssetLedgerBalance" },
      type: "Reports",
      group: "Asset",
    },
    {
      ...
      name: "Asset Schedule",
      url: "/interface",
      state: { type: "ReportQuery", report: "AssetSchedule" },
      type: "Reports",
      group: "Asset",
    },
    {
      code: "fordpct",
      name: "Forecast Depreciation",
      url: "/interface",
      state: { type: "ReportQuery", report: "ForecastDepreciation" },
      type: "Reports",
      group: "Asset",
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "FinancialStatements" },
      type: "Reports",
      group: "Cost and Accounting",
    },
    {
      ...
      name: "General Ledger",
      url: "/interface",
      state: { type: "ReportQuery", report: "GeneralLedger" },
      type: "Reports",
      group: "Cost and Accounting",
    },
    {
      code: "balgen",
      name: "General Ledger Balance",
      url: "/interface",
      state: { type: "ReportQuery", report: "GeneralLedgerBalance" },
      type: "Reports",
      group: "Cost and Accounting",
    },
    {
      ...
      name: "Cost Ledger",
      url: "/interface",
      state: { type: "ReportQuery", report: "CostLedger" },
      type: "Reports",
      group: "Cost and Accounting",
    },
    {
      code: "balcost",
      name: "Cost Ledger Balance",
      url: "/interface",
      state: { type: "ReportQuery", report: "CostLedgerBalance" },
      type: "Reports",
      group: "Cost and Accounting",
    },
    {
      ...
      name: "Forecast Cost",
      url: "/interface",
      state: { type: "ReportQuery", report: "ForecastCost" },
      type: "Reports",
      group: "Cost and Accounting",
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "AccountingDocument" },
      type: "Reports",
      group: "Cost and Accounting",
    },
    {
      code: "smtrem",
      name: "Remuneration Statement",
      url: "/interface",
      state: { type: "ReportQuery", report: "RemunerationStatement" },
      type: "Reports",
      group: "Human Resources",
    },
    {
    ...
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "EmployeeRegister" },
      type: "Reports",
      group: "Human Resources",
    },
    {
    ...
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "MaterialRegister" },
      type: "Reports",
      group: "Material",
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "MaterialLedger" },
      type: "Reports",
      group: "Material",
    },
    {
      code: "balmat",
      name: "Material Ledger Balance",
      url: "/interface",
      state: { type: "ReportQuery", report: "MaterialLedgerBalance" },
      type: "Reports",
      group: "Material",
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "MaterialSchedule" },
      type: "Reports",
      group: "Material",
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "VendorRegister" },
      type: "Reports",
      group: "Payables and Receivables",
    },
    {
      ...
      name: "Vendor Ledger",
      url: "/interface",
      state: { type: "ReportQuery", report: "VendorLedger" },
      type: "Reports",
      group: "Payables and Receivables",
    },
    {
      code: "balven",
      name: "Vendor Ledger Balance",
      url: "/interface",
      state: { type: "ReportQuery", report: "VendorLedgerBalance" },
      type: "Reports",
      group: "Payables and Receivables",
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "CustomerRegister" },
      type: "Reports",
      group: "Payables and Receivables",
    },
    {
      ...
      url: "/interface",
      state: { type: "ReportQuery", report: "CustomerLedger" },
      type: "Reports",
      group: "Payables and Receivables",
    },
    {
      code: "balcus",
      name: "Customer Ledger Balance",
      url: "/interface",
      state: { type: "ReportQuery", report: "CustomerLedgerBalance" },
      type: "Reports",
      group: "Payables and Receivables",
    },
    {
      ...
      url: "/interface",
      state: { type: "Report", report: "MasterCollection", data: {} },
      type: "Reports",
    ...
    },
    {
      ...
      url: "/interface",
      state: { type: "Report", report: "IncomeTaxSimulator", data: {} },
      type: "Reports",
      group: "Business Intelligence",
    },
  ];
...
function SearchBar() {
  ...
  const contents = [
    ...
    <PopupButton
      ...
      className={"searchBarButton"}
      name={<FaDesktop />}
      component={<DeviceUIInterface />}
    />,
  ];
  return (
    <div className="searchBarOuter">
      <div className="searchBar">{contents.map((item) => item)}</div>
    </div>
  );
}

function TitleCard() {
  return <h1 className="title">Simple Costs</h1>;
}
...
function Navigation({ type, next }) {
  ...
  const keyDownHandler = (e, code) => {
    if (e.key === "Enter" || e.key === " ") {
      e.preventDefault();
      navigate(code["url"], { state: code["state"] });
      console.log(e.key);
    }
  };
  return (
    <div className="menuContainer">
      <h3 className="menuContainerTitle" onClick={() => navigate(`/${next}`)}>
        {type}
      </h3>
      {groups.map((group) => (
...
function Record() {
  return <Navigation type={"Record"} next={"reports"} />;
}

function Control() {
  return <Navigation type={"Control"} next={"record"} />;
}

function Reports() {
  return <Navigation type={"Reports"} next={"control"} />;
}
...
const Popup = ({ show, onClose, children, onKeyDown }) => {
  if (!show) {
    return null;
  }
...
const PopupButton = ({ name, component, className, buttonRef, refIndex }) => {
  ...
  return (
    <div onKeyDown={(e) => keyDownHandler(e)}>
      <button
        ref={(el) => (buttonRef.current[refIndex] = el)}
        className={className}
        onClick={() => togglePopup()}
      >
        {name}
...
class Collection {
      ...
      switch (this.name) {
        ...
        case "AssetConstructionOrder":
          defaults = {
            ...
            Code: "",
            Description: "",
            Settlement: [{ Receiver: "", Percentage: "" }],
            Status: "Draft",
          };
          break;
        case "Attendance":
          defaults = {
            ...
            Attendance: datesInMonth(data["Year"], data["Month"]).map(
              (item) => ({ Date: item, Status: "Present", Remarks: "" })
            ),
          };
          break;
        case "BankAccount":
          defaults = {
            ...
            "Post Interest": "",
            "Interest Rate": [
              { From: "", To: "", Rate: "", Debit: "Yes", Credit: "Yes" },
            ],
            "Virtual Accounts": [
              {
        ...
        case "Customisation":
          defaults = {
            "Company Code": data["Company Code"],
            Numbering: KB.Numbering.map((item) => ({
              Item: item,
              From: "",
              To: "",
            })),
        ...
        case "Employee":
          defaults = {
            ...
            "One Time Wages": [{ "Wage Type": "", Amount: "", Date: "" }],
            "Income Tax Code": "",
        ...
        case "GeneralLedger":
          defaults = {
            Code: "",
            "Company Code": data["Company Code"],
            "Chart of Accounts": new Company(data["Company Code"]).data[
              "Chart of Accounts"
            ],
            Description: "",
            ...
            "Post Forex": "Yes",
            "Post Interest": "Yes",
            "Group Chart of Accounts": new Company(data["Company Code"]).data[
              "Group Chart of Accounts"
            ],
            ...
            "Cost Distribution": [
              {
                From: "",
                To: "",
                Ratio: [{ Material: "", Multiplier: "", Remarks: "" }],
              },
            ],
            Status: "",
          };
        ...
        case "PaymentTerms":
          defaults = {
            ...
            Description: "",
            "Due Within Days": 0,
            "Discount Criteria": [{ Days: 0, Rate: 0 }],
            "Interest Criteria": [{ Days: 0, Rate: 0 }],
          };
          break;
        case "Plant":
          defaults = {
        ...
        case "Service":
          defaults = {
            ...
            "Company Code": "",
            Name: "",
            Price: [{ "Business Place": "", From: "", To: "", Price: "" }],
  ...
  process(data) {
    ...
    switch (this.name) {
      case "Asset":
        const criteria1 =
          result["Company Code"] !== "" && result["Asset Group"] !== "";
        if (criteria1) {
  ...
  schema(data) {
    ...
    switch (this.name) {
      case "Asset":
        const criteria1 = data["Company Code"] !== "";
        if (criteria1) {
          ...
          schema = [
            ...
            },
            {
              ...
              input: "input",
              type: "text",
              noteditable: !(this.method == "Create"),
            },
            {
              name: "Description",
              datatype: "single",
            ...
            {
              name: "Asset Group Description",
              datatype: "single",
              noteditable: true,
            },
            { name: "Depreciable", datatype: "single", noteditable: true },
            {
              name: "Date of Capitalisation",
              datatype: "single",
              input: "input",
              type: "date",
              noteditable: !this.editable,
            ...
            {
              name: "Organisational Assignment",
              datatype: "collection",
              noteditable: !this.editable,
              schema: data["Organisational Assignment"].map((item) => [
                {
                  name: "From",
                  datatype: "single",
                  input: "input",
            ...
            },
            {
              ...
              noteditable: !this.editable || !depreciable,
            },
            {
              ...
              noteditable:
                !this.editable ||
                data["Depreciation Method"] != "Reducing Balance" ||
                !depreciable,
            },
            {
              name: "Useful Life",
              ...
              noteditable:
                !this.editable ||
                data["Depreciation Method"] != "Straight Line" ||
                !depreciable,
            },
            {
              name: "Salvage Value",
      ...
      case "AssetGroup":
        schema = [
          ...
          },
          {
            ...
            options: [
              ...
              ...new CompanyCollection(
                data["Company Code"],
                "GeneralLedger"
              ).filteredList({ "Ledger Type": "Asset" }, "Code"),
            ],
            noteditable: this.method != "Create",
          },
          {
            name: "General Ledger - Depreciation",
            datatype: "single",
            input: "option",
            options: [
              "",
              ...new CompanyCollection(
                data["Company Code"],
                "GeneralLedger"
              ).filteredList({ "Ledger Type": "Depreciation" }, "Code"),
            ],
            noteditable: !(
              data["Depreciable"] === "Yes" && this.method === "Create"
            ),
          },
          {
            name: "General Ledger - Accumulated Depreciation",
            datatype: "single",
            input: "option",
            options: [
              "",
          ...
          {
            name: "General Ledger - Gain on Disposal",
            datatype: "single",
            input: "option",
            options: [
              "",
          ...
          {
            name: "General Ledger - Loss on Disposal",
            datatype: "single",
            input: "option",
            options: [
              "",
          ...
          {
            name: "General Ledger - Loss on Retirement",
            datatype: "single",
            input: "option",
            options: [
              "",
      ...
      case "AssetConstructionOrder":
        schema = [
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Settlement"].map((item) => [
              {
                name: "Asset",
                datatype: "single",
                input: "option",
      ...
      case "ChartOfAccounts":
        schema = [
          ...
          {
            name: "General Ledger Numbering",
            datatype: "collection",
            noteditable: true,
            schema: data["General Ledger Numbering"].map((item) => [
              {
                name: "Group",
                datatype: "single",
                input: "input",
  ...
  errors(data) {
    let errors = [];
    if (this.method == "Create" && this.exists(data)) {
      errors.push(
        `${this.title} with same ${this.identifiers.join(",")} already exists.`
      );
    }
    switch (this.name) {
      case "Asset":
        errors.push(
          ...
          ...timeSeriesError(
            "Organisational Assignment",
            data["Organisational Assignment"],
            "From",
            "To"
          ),
          ...collectionError(
      ...
      case "ChartOfAccounts":
        errors.push(
          ...blankError(data, ["Code"]),
          ...collectionError(
            "General Ledger Numbering",
            data["General Ledger Numbering"],
            [],
            "From",
            "To"
          )
    ...
    let navigation = [
      {
        name: "Export",
        type: "action",
        onClick: () => Operations.downloadJSON(result, "Collection"),
        refresh: false,
      },
      {
        name: "Back",
  ...
  interface(data) {
    ...
    switch (this.name) {
      case "AssetConstructionOrder":
        //errors:
        SumField(data["Settlement"], "Percentage") > 100
          ? list.push(`Total of settlement percentage cannot be more than 100`)
          : () => {};
        ...
        //processing
        result["Settlement"] = result["Settlement"].map((item) =>
          item["Asset"] !== "" && result["Company Code"] !== ""
            ? {
                ...item,
      ...
      case "Attendance":
        schema = [
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: true,
            schema: data["Attendance"].map((item) => [
              {
                name: "Date",
                datatype: "single",
                input: "input",
      ...
      case "BankAccount":
        schema = [
          ...
          },
          {
            ...
            options: [
              ...
              ...new CompanyCollection(
                data["Company Code"],
                "GeneralLedger"
              ).filteredList({ "Ledger Type": "Bank Account" }, "Code"),
            ],
            noteditable: !this.method == "Create",
          },
          {
            ...
            datatype: "single",
            input: "option",
            options: ["", ...new Company(data["Company Code"]).BusinessPlaces],
            noteditable: !this.editable,
          },
          {
            name: "Profit Center",
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Interest Rate"].map((item) => [
              {
                name: "From",
                datatype: "single",
                input: "input",
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Virtual Accounts"].map((item) => [
              {
      ...
      case "Company":
        schema = [
          ...
          {
            name: "Places of Business",
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Places of Business"].map((item) => [
              {
                name: "Place",
                datatype: "single",
                input: "input",
          ...
          },
          {
            ...
            datatype: "single",
            input: "option",
            options: ["", ...new Collection("ChartOfAccounts").listAll("Code")],
            noteditable: !(this.method == "Create"),
          },
          {
            name: "Group Chart of Accounts",
            datatype: "single",
            input: "option",
            options: [
              "",
      ...
      case "CostCenter":
        schema = [
          ...
          },
          {
            ...
            datatype: "nest",
            noteditable: !this.editable,
            schema: data["Allocation Ratio"].map((item) => [
              {
                name: "From",
                datatype: "single",
                input: "input",
              ...
              },
              {
                ...
                datatype: "collection",
                noteditable: !this.editable,
                schema: item["Ratio"].map((subitem, i) => [
                  {
                    name: "Type",
                    datatype: "single",
                    input: "option",
      ...
      case "Customer":
        schema = [
          ...
          },
          {
            ...
            datatype: "single",
            input: "option",
            options: ["", ...new Collection("PaymentTerms").listAll("Code")],
            noteditable: !this.editable,
          },
          {
            name: "Bank Accounts",
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Bank Accounts"].map((item) => [
              {
                name: "Ref ID",
                datatype: "single",
                input: "input",
      ...
      case "Customisation":
        schema = [
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: true,
            schema: data["Numbering"].map((item) => [
              {
                name: "Item",
                datatype: "single",
                input: "input",
      ...
      case "Employee":
        schema = [
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Employment Details"].map((item) => [
              {
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Variable Wages"].map((item) => [
              {
                name: "Wage Type",
                datatype: "single",
                input: "input",
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Fixed Wages"].map((item) => [
              {
                name: "Wage Type",
                datatype: "single",
                input: "input",
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["One Time Wages"].map((item) => [
              {
                name: "Wage Type",
                datatype: "single",
                input: "input",
          ...
          {
            name: "Additional Income and Deductions",
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Additional Income and Deductions"].map((item) => [
              {
                name: "Tax Year",
                datatype: "single",
                input: "input",
      ...
      case "FinancialStatement":
        schema = [
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Hierarchy"].map((item) => [
              {
                name: "Presentation",
                datatype: "single",
                input: "input",
              ...
              },
              {
                name: "Hierarchy",
                input: "input",
                placeholder: "eg: Current Assets > Inventory",
                datatype: "single",
                type: "text",
                noteditable: !this.editable,
              },
      ...
      case "GeneralLedger":
        schema = [
          ...
          },
          {
            ...
            noteditable:
              this.method !== "Create" ||
              data["Ledger Type"] !== "General Ledger",
          },
          {
        ...
        !valueInRange(
          data["Code"],
          new ChartOfAccounts(data["Company Code"]).range(data["Group"])
        )
          ? list.push(
              `General Ledger code ${data["Code"]} not in range for ${
                data["Group"]
              } ${JSON.stringify(
                new ChartOfAccounts(data["Company Code"]).range(data["Group"])
              )}`
        ...
        schema = [
          ...
          },
          {
            ...
            schema: data["Taxation"].map((item) => [
              ...
              {
                name: "Standard Deduction - Salary",
                input: "input",
                datatype: "single",
                type: "number",
                noteditable: !this.editable,
      ...
      case "Location":
        schema = [
          ...
          },
          {
            ...
            datatype: "nest",
            noteditable: !this.editable,
            schema: data["Cost Distribution"].map((item) => [
              {
                name: "From",
                datatype: "single",
                input: "input",
        ...
        schema = [
          ...
          },
          {
            ...
            options: [
              ...
              ...new CompanyCollection(data["Company Code"], "Plant").listAll(
                "Code"
              ),
              ...new CompanyCollection(
                data["Company Code"],
      ...
      case "MaterialGroup":
        schema = [
          ...
          },
          {
            ...
            options: [
              ...
              ...new CompanyCollection(
                data["Company Code"],
                "GeneralLedger"
              ).filteredList({ "Ledger Type": "Material" }, "Code"),
            ],
            noteditable: !(this.method == "Create"),
          },
          {
            name: "General Ledger - Revenue",
            datatype: "single",
            input: "option",
            options: [
              "",
          ...
          {
            name: "General Ledger - Cost of Sales",
            datatype: "single",
            input: "option",
            options: [
              "",
      ...
      case "PaymentTerms":
        schema = [
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Discount Criteria"].map((item) => [
              {
                name: "Days",
                datatype: "single",
                input: "input",
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Interest Criteria"].map((item) => [
              {
                name: "Days",
                datatype: "single",
                input: "input",
      ...
      case "ProfitCenter":
        schema = [
          ...
          },
          {
            ...
            datatype: "single",
            input: "option",
            options: ["", ...new Table("Segments").list],
            noteditable: !(this.method == "Create"),
          },
          {
            name: "Description",
      ...
      case "TimeControl":
        schema = [
          ...
          },
          {
            ...
            datatype: "collection",
            noteditable: !this.editable,
            schema: data["Open Periods"].map((item) => [
              {
                name: "From",
                datatype: "single",
                input: "input",
    ...
    this.method == "Create" && this.exists(data)
      ? list.push(
          `Record of ${this.title} with same identfiers ${JSON.stringify(
            this.identifiers
          )} already exists`
        )
      : () => {};
    KB.AccountTypes.includes(this.title) &&
    data["Code"] != "" &&
    !valueInRange(
      data["Code"],
      new Company(data["Company Code"]).CollectionRange(this.title)
    )
      ? list.push(
          `${this.title} code ${data["Code"]} not in range for Company ${
            data["Company Code"]
          } (${JSON.stringify(
            new Company(data["Company Code"]).CollectionRange(this.title)
          )})`
    ...
    switch (this.name) {
      case "Attendance":
        data["Attendance"].map((item) =>
          item["Status"] == ""
            ? list.push(`Attendance missing for ${item["Date"]}`)
            : () => {}
        );
        break;
      case "BankAccount":
        ...
        for (let i = 0; i < vans.length; i++) {
          ...
          if (
            ...
            list.push(
              `VAN '${van["Virtual Account Number"]}' exists in duplicate`
            );
          }
          const necessary = [
            "Virtual Account Number",
          ...
          necessary.map((field) =>
            van[field] === ""
              ? list.push(`At VAN ${i + 1}, ${field} necessary.`)
              : () => {}
          );
        }
        break;
      case "ChartOfAccounts":
        this.method == "Create" &&
        new Collection("GroupChartOfAccounts").exists(data)
          ? list.push(
              `Group Chart of Accounts with same identifier(s) already exists`
            )
          : () => {};
        data["General Ledger Numbering"].map((item, i) =>
          item["From"] == "" || item["To"] == ""
            ? list.push(`Group ${item["Group"]} requires range`)
            : () => {}
        );
        data["General Ledger Numbering"].map((item, i) =>
          Number(item["From"]) >= Number(item["To"])
            ? list.push(
                `${item["Group"]}: 'To' range needs to be greater than 'from' range`
              )
            : () => {}
        );
        for (let i = 1; i < data["General Ledger Numbering"].length; i++) {
          Number(data["General Ledger Numbering"][i]["From"]) <=
          Number(data["General Ledger Numbering"][i - 1]["To"])
            ? list.push(
                `'From' range of ${
                  data["General Ledger Numbering"][i]["Group"]
                } to be greater than 'To' range of ${
                  data["General Ledger Numbering"][i - 1]["Group"]
                }`
              )
            : () => {};
        }
      ...
      case "CostCenter":
        ...
        for (let i = 0; i < allocations.length; i++) {
          ...
          if (i > 0 && allocation["From"] <= allocations[i - 1]["To"]) {
            list.push(
              `At allocation ${i + 1}, 'From' is lower than previous 'To'`
            );
          }
          ...
          if (SumField(ratios, "Percentage") > 100) {
            list.push(
              `At allocation ${i + 1}, total of ratios greater than 100.`
            );
          }
        }
        break;
      ...
      case "Customisation":
        ...
        numbering.forEach((item) => {
          Number(item["From"]) < 0
            ? list.push(`For ${item["Item"]}, 'From' is negative.`)
            : () => {};
          Number(item["To"]) < 0
            ? list.push(`For ${item["Item"]}, 'To' is negative.`)
            : () => {};
          Number(item["From"]) > Number(item["To"])
            ? list.push(`For ${item["Item"]}, 'From' is greater than 'To'.`)
            : () => {};
        });
        break;
      case "Employee":
      ...
      case "FinancialStatement":
        data["Hierarchy"].map((item, i) =>
          item["Presentation"] == "" || item["Hierarchy"] == ""
            ? list.push(`Hierarchy ${i + 1}: Information incomplete.`)
            : () => {}
        );
        data["Hierarchy"].length == 0
          ? list.push("At least one Hierarchy is required")
          : () => {};
        data["Hierarchy"].map((item) =>
          Count(item["Hierarchy"], ListItems(data["Hierarchy"], "Hierarchy")) >
          1
            ? list.push(`${item["Hierarchy"]} repeats in Hierarchy`)
            : () => {}
        );
        this.exists(data)
          ? list.push(`${this.title} with same identifier(s) already exists`)
          : () => {};
        break;
      case "GeneralLedger":
        break;
      case "GroupChartOfAccounts":
        this.method == "Create" &&
        new Collection("ChartOfAccounts").exists(data)
          ? list.push(
              `Chart of Accounts with same identifier(s) already exists`
            )
          : () => {};
        data["General Ledger Numbering"].map((item, i) =>
          item["From"] == "" || item["To"] == ""
      ...
      case "Holidays":
        ...
        for (let i = 0; i < holidays.length; i++) {
          ...
          necessary.map((field) =>
            holiday[field] === ""
              ? list.push(`At holiday ${1 + i}, ${field} necessary.`)
              : () => {}
          );
          !valueInRange(new Date(holiday["Date"]), [
            new Date(
              new Company(data["Company Code"]).yearData(data["Year"]).begin
            ),
            new Date(
              new Company(data["Company Code"]).yearData(data["Year"]).end
            ),
          ])
            ? list.push(`Date ${i + 1} not in the year.`)
            : () => {};
        }
        break;
      case "IncomeTaxCode":
        ...
        taxations.forEach((taxation, i) => {
          ...
          if (taxation["From Year"] > taxation["To Year"]) {
            list.push(
              `At taxation ${i + 1}, 'From Year' greater than 'To Year'.`
            );
          }
          if (i > 0 && taxation["From Year"] > taxations[i - 1]["To Year"]) {
            list.push(
              `At taxation ${i + 1}, 'From Year' lower than previous 'To Year'.`
            );
          }
          ...
          slabs.forEach((slab, s) => {
            ...
            necessary.forEach((field) => {
              if (slab[field] === "") {
                list.push(
                  `At taxation ${i + 1}, slab ${s + 1}, '${field}' necessary.`
                );
              }
              if (slab[field] < 0) {
                list.push(
                  `At taxation ${i + 1}, slab ${s + 1}, '${field}' is negative.`
                );
              }
            });
            if (slab["From"] >= slab["To"]) {
              list.push(
                `At taxation ${i + 1}, slab ${
                  s + 1
            ...
            if (s > 0 && slab["From"] < slabs[s - 1]["To"]) {
              list.push(
                `At taxation ${i + 1}, slab ${
                  s + 1
                }, 'From' is lower than previous 'To'.`
              );
            }
          });
          if (slabs[slabs.length - 1]["To"] < 999999999) {
            list.push(
              `At taxation ${
                i + 1
              }, 'To of last tax slab must be 999999999 or higher.'`
            );
          }
        });
        break;
      case "Location":
        ...
        for (let i = 0; i < lcostdist.length; i++) {
          ...
          necessary.map((field) =>
            distribution[field] === ""
              ? list.push(`At distribution ${i + 1}, ${field} required.`)
              : () => {}
          );
          ...
          if (i > 0 && distribution["From"] <= distribution[i - 1]["To"]) {
            list.push(
              `At distribution ${i + 1}, 'From' is lower than previous 'To'`
            );
          }
      ...
      case "Material":
        data["Price"].map((item, i) =>
          ...
          item["From"] == "" ||
          (item["To"] == "" && item["Price"] == "")
            ? list.push(`At Price line ${i}, information incomplete`)
            : () => {}
        );
        break;
      case "PaymentTerms":
        this.exists(data)
          ? list.push(`${this.title} with same identifier(s) already exists`)
          : () => {};
        data["Discount Criteria"].map((item, i) =>
          item["Days"] == "" || item["Discount %"] == ""
            ? list.push(`At Terms line ${i}, information incomplete`)
            : () => {}
        );
        data["Interest Criteria"].map((item, i) =>
          item["Days"] == "" || item["Interest %"] == ""
            ? list.push(
                `At Interest Criteria line ${i}, information incomplete`
              )
            : () => {}
        );
        break;
      ...
      case "PurchaseOrder":
        ...
        data["Items"].map((item, i) =>
          ...
          item["Unit Price"] == "" ||
          item["Total Price"] == ""
            ? list.push(`At Items line ${i}, information incomplete`)
            : () => {}
        );
        break;
      case "RevenueCenter":
      ...
      case "Service":
        ...
        break;
      case "TimeControl":
        data["Open Periods"].map((item, i) =>
          item["From"] == "" || item["To"] == ""
            ? list.push(`At Open Periods line ${i}, information incomplete`)
            : () => {}
        );
        data["Open Periods"].map((item, i) =>
          new Date(item["From"]) > new Date(item["To"])
            ? list.push(
                `At Open Periods line ${i}, 'To' date should be after 'From' date`
              )
            : () => {}
        );
        break;
    ...
    const missed = [];
    mandatory.map((field) =>
      data[field] === "" ? missed.push(field) : () => {}
    );
    missed.length > 0 ? list.push(`${missed.join(", ")} necessary`) : () => {};
    nonNegatives.map((field) =>
      data[field] < 0 ? list.push(`${field} cannot be negative.`) : () => {}
    );
    const uniquelist = [...new Set(errors)];
    switch (this.name) {
      case "Asset":
        result["Depreciation Rate"] =
          result["Depreciation Method"] != "Reducing Balance"
            ? ""
            : result["Depreciation Rate"];
  ...
  delete(data) {
    ...
    for (let i = 0; i < collection.length; i++) {
      ...
      if (logic) {
        result = result.filter((item, index) => index !== i);
      }
    }
    return result;
  }
  ...
  static mandatory = {
    ...
    AssetGroup: [
      ...
      "Depreciable",
      "General Ledger - Asset",
      "General Ledger - Gain on Revaluation",
      "General Ledger - Gain on Disposal",
      "General Ledger - Loss on Disposal",
      "General Ledger - Loss on Retirement",
    ],
    ...
    FinancialAccountsSettings: [
      "Company Code",
      "General Ledger for Profit and Loss Account",
...
class IncomeTaxCode extends Collection {
  ...
  yearExists(year) {
    const result = this.data["Taxation"].find(
      (item) => year >= item["From Year"] && year <= item["To Year"]
    );
    return result !== undefined;
  }
  taxation(year) {
    const taxation = this.data["Taxation"];
    const taxationyear = taxation.filter(
      (item) => year >= item["From Year"] && year <= item["To Year"]
    )[0];
    return taxationyear;
  }
...
const DeviceUIInterface = () => {
  const DeviceUI = new Dictionary("DeviceUI");
  const initial =
    DeviceUI.load() !== null
      ? DeviceUI.load()
      : { Background: "Tech", Font: "Lexend" };
  const [data, setdata] = useState(initial);
  const navigate = useNavigate();
  return (
    <div className="popupDisplay" style={{ minWidth: "400px" }}>
      <div className="displayTitle">
        <h3>Device UI Settings</h3>
      </div>
...
const IncomeTaxSimulator = () => {
  ...
  let output = { ...data };
  if (output["Income Tax Code"] !== "" && output["Financial Year"] !== "") {
    const IT = new IncomeTaxCode(output["Income Tax Code"]);
    if (IT.yearExists(data["Financial Year"])) {
      output["Tax on Total Income"] = IT.tax(
        Number(output["Financial Year"]),
        Number(output["Total Income"])
      );
      output["Marginal Relief"] = IT.marginalRelief(
        output["Financial Year"],
        output["Total Income"]
      );
      output["Net Tax on Total Income"] = IT.netTax(
        Number(output["Financial Year"]),
        Number(output["Total Income"])
      );
    }
  ...
  return (
    <Window>
      <Title title={"Income Tax Simulate"} />
      <Option
        output={output}
        setdata={setdata}
        name={"Income Tax Code"}
      ...
      <Input
        ...
        type={"number"}
      />
      <Label output={output} name={"Tax on Total Income"} />
      <Label output={output} name={"Marginal Relief"} />
      <Label output={output} name={"Net Tax on Total Income"} />
      <Button name={"Create Income Tax Code"} />
    </Window>
  );
};
...
function App() {
  ...
  const initial =
    DeviceUI.load() !== null
      ? DeviceUI.load()
      : { Background: "Tech", Font: "Lexend" };
  const [uiData, setUiData] = useState(initial);
  const { Background, Font } = uiData;
